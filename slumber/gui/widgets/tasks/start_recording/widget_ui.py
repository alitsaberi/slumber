...
"}")
        ...
        self.button_recording.setObjectName(u"button_recording")
        ...
        self.button_recording.setStyleSheet(u"QPushButton {\n"
"	color: rgb(255, 255, 255);\n"
"	background-color: rgb(1, 92, 187);\n"
"	border: 1px;\n"
"	border-radius: 10px;\n"
...
"}")
    ...
    def retranslateUi(self, Widget):
        ...
        self.button_recording.setText(QCoreApplication.translate("Widget", u"Start Recording", None))
    # retranslateUi
