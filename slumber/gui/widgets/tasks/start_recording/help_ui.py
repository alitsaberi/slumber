...
class Ui_HelpDialog(object):
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", u"Slumber - Start Recording", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", u"Start Recording - dialog window works.", None))
