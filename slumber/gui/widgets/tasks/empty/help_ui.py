...
class Ui_HelpDialog(object):
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", u"Slumber - {{ header }}", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", u"{{ name }} - dialog window works.", None))
