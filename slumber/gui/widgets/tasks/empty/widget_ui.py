...
"                                    }")
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", u"{{ header}}", None))
        self.widget_title.setText(QCoreApplication.translate("Widget", u"{{ header }}", None))
        self.button_info.setText("")
        self.label_body.setText(QCoreApplication.translate("Widget", u"{{ name }} works correctly.", None))
    # retranslateUi
