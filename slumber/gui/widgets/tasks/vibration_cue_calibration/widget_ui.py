...
class Ui_VibrationCueCalibrationPage(object):
    def setupUi(self, VibrationCueCalibrationPage):
        if not VibrationCueCalibrationPage.objectName():
            VibrationCueCalibrationPage.setObjectName(u"VibrationCueCalibrationPage")
        VibrationCueCalibrationPage.resize(800, 600)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(VibrationCueCalibrationPage.sizePolicy().hasHeightForWidth())
        VibrationCueCalibrationPage.setSizePolicy(sizePolicy)
        VibrationCueCalibrationPage.setMaximumSize(QSize(3840, 2160))
        self.verticalLayout = QVBoxLayout(VibrationCueCalibrationPage)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.header = QHBoxLayout()
        self.header.setObjectName(u"header")
        self.header.setSizeConstraint(QLayout.SizeConstraint.SetMaximumSize)
        self.title = QLabel(VibrationCueCalibrationPage)
        ...
        self.info_button = QPushButton(VibrationCueCalibrationPage)
...
"                                    }")
        ...
        self.cue_button = QPushButton(VibrationCueCalibrationPage)
...
"border-radius: 5px;")
        ...
        self.status_label = QLabel(VibrationCueCalibrationPage)
...
"            border-radius: 10px;")
        ...
        self.timer_display = QLCDNumber(VibrationCueCalibrationPage)
        ...
        self.retranslateUi(VibrationCueCalibrationPage)

        QMetaObject.connectSlotsByName(VibrationCueCalibrationPage)
    # setupUi

    def retranslateUi(self, VibrationCueCalibrationPage):
        VibrationCueCalibrationPage.setWindowTitle(QCoreApplication.translate("VibrationCueCalibrationPage", u"{{ header}}", None))
        self.title.setText(QCoreApplication.translate("VibrationCueCalibrationPage", u"{{ header }}", None))
        self.info_button.setText("")
        self.cue_button.setText(QCoreApplication.translate("VibrationCueCalibrationPage", u"Present Cue", None))
