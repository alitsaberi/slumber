...
class Ui_AudioCueCalibrationPage(object):
    def setupUi(self, AudioCueCalibrationPage):
        if not AudioCueCalibrationPage.objectName():
            AudioCueCalibrationPage.setObjectName(u"AudioCueCalibrationPage")
        AudioCueCalibrationPage.resize(800, 600)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(AudioCueCalibrationPage.sizePolicy().hasHeightForWidth())
        AudioCueCalibrationPage.setSizePolicy(sizePolicy)
        AudioCueCalibrationPage.setMaximumSize(QSize(3840, 2160))
        self.verticalLayout = QVBoxLayout(AudioCueCalibrationPage)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.header = QHBoxLayout()
        self.header.setObjectName(u"header")
        self.header.setSizeConstraint(QLayout.SizeConstraint.SetMaximumSize)
        self.title = QLabel(AudioCueCalibrationPage)
        ...
        self.info_button = QPushButton(AudioCueCalibrationPage)
...
"                                    }")
        ...
        self.status_label = QLabel(AudioCueCalibrationPage)
...
"            border-radius: 10px;")
        ...
        self.decrease_intensity_button = QPushButton(AudioCueCalibrationPage)
...
"border-radius: 5px;")
        ...
        self.intensity_display = QLCDNumber(AudioCueCalibrationPage)
        ...
        self.increase_intensity_button = QPushButton(AudioCueCalibrationPage)
...
"border-radius: 5px;")
        ...
        self.cue_button = QPushButton(AudioCueCalibrationPage)
...
"border-radius: 5px;")
        ...
        self.perception_widget = QWidget(AudioCueCalibrationPage)
...
"                border-radius: 5px;")
        ...
        self.retranslateUi(AudioCueCalibrationPage)

        QMetaObject.connectSlotsByName(AudioCueCalibrationPage)
    # setupUi

    def retranslateUi(self, AudioCueCalibrationPage):
        AudioCueCalibrationPage.setWindowTitle(QCoreApplication.translate("AudioCueCalibrationPage", u"{{ header}}", None))
        self.title.setText(QCoreApplication.translate("AudioCueCalibrationPage", u"{{ header }}", None))
        self.info_button.setText("")
        self.status_label.setText("")
        self.decrease_intensity_button.setText(QCoreApplication.translate("AudioCueCalibrationPage", u"-", None))
        self.increase_intensity_button.setText(QCoreApplication.translate("AudioCueCalibrationPage", u"+", None))
        self.cue_button.setText(QCoreApplication.translate("AudioCueCalibrationPage", u"Present Cue", None))
        self.perception_label.setText(QCoreApplication.translate("AudioCueCalibrationPage", u"Did you perceive the cue", None))
        self.no_button.setText(QCoreApplication.translate("AudioCueCalibrationPage", u"No", None))
        self.yes_button.setText(QCoreApplication.translate("AudioCueCalibrationPage", u"Yes", None))
    # retranslateUi
