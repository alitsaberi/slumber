...
class Ui_mainWidget(object):
    def setupUi(self, mainWidget):
        ...
        mainWidget.resize(1267, 877)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(mainWidget.sizePolicy().hasHeightForWidth())
        mainWidget.setSizePolicy(sizePolicy)
        mainWidget.setMaximumSize(QSize(3840, 2160))
        ...
        self.procedureStack = QStackedWidget(mainWidget)
        ...
        self.procedureStepList = QListWidget(mainWidget)
...
"                                            }")
        ...
        self.prevButton = QPushButton(mainWidget)
...
"                                                    }")
        ...
        self.nextButton = QPushButton(mainWidget)
...
"                                                    }")
    ...
    def retranslateUi(self, mainWidget):
        ...
        self.prevButton.setText(QCoreApplication.translate("mainWidget", u"Previous", None))
        self.nextButton.setText(QCoreApplication.translate("mainWidget", u"Next", None))
    # retranslateUi
