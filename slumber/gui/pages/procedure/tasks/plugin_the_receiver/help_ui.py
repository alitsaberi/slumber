...
class Ui_HelpDialog(object):
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", u"Slumber - Plugin the receiver", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", u"Plugin the receiver - dialog window works.", None))
