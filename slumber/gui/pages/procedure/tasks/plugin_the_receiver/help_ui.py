...
class Ui_HelpDialog:
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", "Slumber - Plugin the receiver", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", "Plugin the receiver - dialog window works.", None))
