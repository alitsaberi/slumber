...
"}")
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", "Plugin the receiver", None))
        self.widget_title.setText(QCoreApplication.translate("Widget", "Plugin the receiver", None))
        self.button_info.setText("")
        self.label_body.setText(QCoreApplication.translate("Widget", "Plugin the receiver works correctly.", None))
    # retranslateUi
