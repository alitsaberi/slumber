...
class Ui_HelpDialog:
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", "Slumber - Start ZMax Server", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", "Start ZMax Server - dialog window works.", None))
