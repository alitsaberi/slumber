...
class Ui_HelpDialog(object):
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", u"Slumber - Start ZMax Server", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", u"Start ZMax Server - dialog window works.", None))
