...
"}")
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", "Start ZMax Server", None))
        self.widget_title.setText(QCoreApplication.translate("Widget", "Start ZMax Server", None))
        self.button_info.setText("")
        self.label_body.setText(QCoreApplication.translate("Widget", "Start ZMax Server works correctly.", None))
    # retranslateUi
