...
"}")
        ...
        self.button_recording = QPushButton(self.widget_body)
        ...
        sizePolicy1.setHeightForWidth(self.button_recording.sizePolicy().hasHeightForWidth())
        self.button_recording.setSizePolicy(sizePolicy1)
        self.button_recording.setMinimumSize(QSize(300, 50))
        self.button_recording.setStyleSheet("QPushButton {\n"
"	color: rgb(255, 255, 255);\n"
"	background-color: rgb(1, 92, 187);\n"
"	border: 1px;\n"
"	border-radius: 10px;\n"
...
"}")
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", "Start Recording", None))
        self.widget_title.setText(QCoreApplication.translate("Widget", "Start Recording", None))
        self.button_info.setText("")
        self.button_recording.setText(QCoreApplication.translate("Widget", "Start Recording", None))
    # retranslateUi
