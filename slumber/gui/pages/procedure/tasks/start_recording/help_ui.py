...
class Ui_HelpDialog:
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", "Slumber - Start Recording", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", "Start Recording - dialog window works.", None))
