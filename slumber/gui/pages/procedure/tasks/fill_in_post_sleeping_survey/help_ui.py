...
class Ui_HelpDialog(object):
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", u"Slumber - Fill in Post-Sleeping Survey", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", u"Fill in Post-Sleeping Survey - dialog window works.", None))
