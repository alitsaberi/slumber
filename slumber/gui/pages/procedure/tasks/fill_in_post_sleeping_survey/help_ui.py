...
class Ui_HelpDialog:
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", "Slumber - Fill in Post-Sleeping Survey", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", "Fill in Post-Sleeping Survey - dialog window works.", None))
