...
"}")
        ...
        self.webEngineView_post_survey.setObjectName("webEngineView_post_survey")
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", "Fill in Post-Sleeping Survey", None))
        self.widget_title.setText(QCoreApplication.translate("Widget", "Fill in Post-Sleeping Survey", None))
