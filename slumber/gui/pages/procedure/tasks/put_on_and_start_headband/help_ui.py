...
class Ui_HelpDialog:
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", "Slumber - Put on and start headband", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", "Put on and start headband - dialog window works.", None))
