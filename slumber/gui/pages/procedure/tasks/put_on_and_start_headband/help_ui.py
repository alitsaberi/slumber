...
class Ui_HelpDialog(object):
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", u"Slumber - Put on and start headband", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", u"Put on and start headband - dialog window works.", None))
