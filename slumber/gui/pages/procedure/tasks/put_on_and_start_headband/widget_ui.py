...
"}")
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", u"Put on and start headband", None))
        self.widget_title.setText(QCoreApplication.translate("Widget", u"Put on and start headband", None))
        self.button_info.setText("")
        self.label_body.setText(QCoreApplication.translate("Widget", u"Put on and start headband works correctly.", None))
    # retranslateUi
