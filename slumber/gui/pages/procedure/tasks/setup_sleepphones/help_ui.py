...
class Ui_HelpDialog(object):
    ...
    def retranslateUi(self, HelpDialog):
        HelpDialog.setWindowTitle(QCoreApplication.translate("HelpDialog", u"Slumber - Setup SleepPhones", None))
        self.label_body.setText(QCoreApplication.translate("HelpDialog", u"Setup SleepPhones - dialog window works.", None))
