...
"}")
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", u"Setup and calibrate ZMax", None))
        self.widget_title.setText(QCoreApplication.translate("Widget", u"Setup and calibrate ZMax", None))
        self.button_info.setText("")
        self.label_body.setText(QCoreApplication.translate("Widget", u"Setup and calibrate ZMax works correctly.", None))
    # retranslateUi
