...
def create_widget_py(file_path, header, name):
    template = f"""from PySide6.QtWidgets import QWidget, QDialog, QPushButton
...
def generate_ui_py(ui_path, output_path):
    try:
        ...
        print("pyside6-uic command not found. Please ensure PySide6 is installed and pyside6-uic is in your PATH.")
...
def main():
    ...
    base_path = os.path.join("slumber", "gui", "pages", "procedure", "tasks", adjusted_name)
